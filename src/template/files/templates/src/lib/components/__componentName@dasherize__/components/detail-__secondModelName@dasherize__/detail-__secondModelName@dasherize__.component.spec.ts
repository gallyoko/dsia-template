...
import { Detail<%= classify(secondModelName) %>Component } from './detail-<%= dasherize(secondModelName) %>.component';
...
describe('Detail<%= classify(secondModelName) %>Component', () => {
  let component: Detail<%= classify(secondModelName) %>Component;
  let fixture: ComponentFixture<Detail<%= classify(secondModelName) %>Component>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [Detail<%= classify(secondModelName) %>Component],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(Detail<%= classify(secondModelName) %>Component);
